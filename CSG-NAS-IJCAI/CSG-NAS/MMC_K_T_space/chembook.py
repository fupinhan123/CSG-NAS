...
def load_chembookv2(view_data_dir, n_splits=5, idx_split=0, test_size=0.2, seed=1024):
    print('********************** idx_split:', idx_split)
    view_names = ['resnet50', 'desnet121', 'MobileNetV2', 'Xception', 'InceptionV3',
                  'resnet18', 'resnet34', 'desnet169', 'desnet201', 'NASNetMobile']
